...
export const TYPES = [
  ...
  {key:'55A',name:'55㎡A',opts:[
    ...
    {id:'kitchen',cat:'주방 마감 및 가구 특화',label:'주방 벽체 및 상판 엔지니어드 스톤 + 주방가구(아일랜드장)',base:'주방 벽체 도기질타일(600X300,가로방향)및 상판 인조대리석',price:4800000,baseImg:'/assets/types/55A/kitchen-base.jpeg',img:'/assets/types/55A/kitchen-sel.jpeg',notes:['※ 인조대리석 및 석재 / 타일 자재의 경우 제조과정에 따라 무늬 및 색상이 다소 차이가 발생 할 수 있으며, 이는 하자 사항이 아닙니다.','※ 엔지니어드스톤, 인조대리석 등의 색상, 디자인, 재질, 단차, 코너, 마감재접합부, 패턴 등은 본 공사 시 견본주택과 다소 상이할 수 있습니다.','※ 설치되는 가구의 비노출면(후면, 하부, 천장)에는 마루, 타일, 도배, 천연가공석, 엔지니어드스톤 등 마감재가 시공되지 않습니다.']},
    {id:'closet_침실2',cat:'붙박이장',label:'침실2 붙박이장(여닫이)',base:'',price:1700000,baseImg:'/assets/types/55A/closet-base.jpeg',img:'/assets/types/55A/closet-sel.jpeg',notes:['▶ 기본 품목(미선택형): 실크벽지 / 유상 품목(선택형): 침실2 붙박이장','※ 붙박이장과 접해있는 벽, 바닥, 천장에는 마감재가 설치되지 않습니다.']},
    {id:'bath',cat:'욕실마감재 특화',label:'벽체 : 포세린 타일(600X600)',base:'벽체 : 도기질 타일(300X600, 세로방향)',price:500000,notes:['※ 타일은 자재특성상 색상 및 무늬가 동일하지 않고 고유한 물성에 의하여 휠 발생이 생길수 있으며, 타일 나누기는 추가 또는 변경될수있습니다.','※ 욕실 벽, 바닥 타일의 줄눈 위치가 일치하지 않을 수 있으며, 줄눈 및 타일 사이즈가 일정하지 않을 수 있습니다.']},
    {id:'space',cat:'공간(드레스룸) 특화',label:'침실1 가변형벽체(침실1/침실3 통합형)+가구도어+시스템선반',base:'',price:1100000,baseImg:'/assets/types/55A/space-base.jpeg',img:'/assets/types/55A/space-sel.jpeg',notes:['※ 공간특화 옵션 선택 시 부위별 가구 설치 및 레이아웃이 변경될 수 있습니다.','※ 공간특화 옵션 선택 시 타입별 위치에 따라 가구의 방향이 상이할 수 있으니 계약 시 필히 확인하시기 바랍니다.']}
  ],ac:5800000,vent:600000,dual:false,floorPlan:'/assets/types/55A/floor-plan.jpeg'},
